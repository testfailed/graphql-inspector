      ...
      <FeatureList
        ...
        items={[
          ...
          },
          {
            ...
            description:
              'Every new change in GraphQL Inspector is well-tested in our free service.',
            image: {
          ...
          },
          {
            ...
            description:
              'Gain priority in bug fixes. Upgrade assistance and in-person troubleshooting.',
            image: {
          ...
          },
          {
            ...
            description:
              'Contact us on Slack, Discord, Email or any messaging platform and get an immediate response. Get 24x7x365 technical support.',
            image: {
          ...
          },
          {
            ...
            description:
              'Take part in new features decision making. Get a priority and shape GraphQL Inspector with us. Get everything tailored to your needs, even more.',
            image: {
